        ...
        <div class="col-sm-9">
            <form class="form-horizontal">
                <div class="form-group">
                    <label for="profile" class="col-sm-3 control-label">現有管理人員權限類別名稱</label>
                    <div class="col-sm-9">
                        <select name="profile" id="profile" class="form-control" autofocus>
                ...
                <div class="form-group">
                    <label for="newProfile" class="col-sm-3 control-label">新增管理人員權限類別名稱</label>
                    <div class="col-sm-9">
                        <input type="email" class="form-control" id="newProfile" placeholder="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="loginName" class="col-sm-3 control-label">權限名稱</label>
                    <div class="col-sm-9">
