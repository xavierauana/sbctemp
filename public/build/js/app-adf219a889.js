...
exports["default"] = {
    ...
    methods: {
        ...
        toggleTooltip: function toggleTooltip(e) {
            e.keyCode < 48 || e.keyCode > 57 ? $('#docTypeIndex').tooltip('show') : $('#docTypeIndex').tooltip('hide');
        }
    },
    ready: function ready() {
        document.getElementById("docTypeIndex").addEventListener("keypress", this.toggleTooltip);
        $("#docTypeIndex").tooltip({
            trigger: 'manual',
            title: "number only"
        });
    }
...
},{"vue":25,"vue-hot-reload-api":16,"vueify-insert-css":26}],40:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n    iframe{\n        width: 100%;\n        height: 550px;\n    }\n")
'use strict';
